        ...
        <div className='sticky top-0 z-10 mb-20'>
            <div className='flex justify-between px-20 py-5 bg-white border-b-2 border-neutral-200'> 
                ...
                <div className='flex justify-center items-center gap-8'>
                    ...
                    <NavLink className='text-[16px] font-medium' to='/'>App</NavLink>
                    <NavLink className='text-[16px] font-medium' to='/'>Installation</NavLink>
                </div>
                <div className='flex justify-center items-center gap-2.5 py-3 px-4 rounded-sm bg-[#632EE3]'>
